classdef Leg < matlab.mixin.SetGet
    ...
    %% Display output in 
    % Line 238-242    Display bodies and joints(Deletable)
    % Line 284-293    Display muscle names(Deletable)
    % Line 345-350    Display attachment associate with muscle(Deletable)
    % Line 435-443    Display attachment associate with body and it's position(Deletable)
